...
Welcome to `reglm` contributor's guide.
...
If you experience bugs or general issues with `reglm`, please have a look
...
You can help improve `reglm` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`reglm` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `reglm`'s files. While this mechanism can
...
```
conda create -n reglm python=3 six virtualenv pytest pytest-cov
conda activate reglm
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/reglm.git
   cd reglm
   ```
...
5. Install [pre-commit]:
   ...
   `reglm` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/reglm
[issue tracker]: https://github.com/<USERNAME>/reglm/issues
